...
export const Novel = ({ novel }: Props) => {
	...
	return (
		<article className="flex flex-col p-4 mt-10 pt-10 bg-slate-200 dark:bg-zinc-800 hover:scale-110 shadow-sm hover:shadow-lg hover:bg-slate-300 transition duration-300 ease-out text-white ">
			{/* image */}
			{novel.image && (
				<div>
					<img
